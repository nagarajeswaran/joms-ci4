...
<thead class="table-dark"><tr>
    <th>Batch No</th><th>Part</th><th>Stamp</th><th>Pc Weight (g)</th><th>Touch%</th><th>Qty in Stock</th><th>Source Order</th><th>Created</th><th>Actions</th>
</tr></thead>
<tbody>
...
<tr>
    ...
    <td><?= $row['touch_pct'] ?>%</td>
    <td><span class="badge <?= $row['qty_in_stock'] > 0 ? 'bg-success' : 'bg-secondary' ?>"><?= $row['qty_in_stock'] ?></span></td>
